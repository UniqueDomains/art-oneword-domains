# Available .ART One-Word Domains (8,725)
...
**Public extract:** 8,725 rows · **Live catalog:** 8,725 domains
...
- `art.csv` — public CSV extract (8,725 rows)
- `art.json` — public JSON extract (8,725 rows)
...
| -------------- | --------- | --------- | ------------- | -------------- | ------ | ------ | ----------------------------------------- |
| doable.art     | available | $5.99     | $39.99        | 96             | 13     | 6      | name.com                                  |
...
| ----------------------- | ------------------------------------------------ |
| 8,725-row public sample | 8,725 live domains                               |
...
> Unique Domains. *Available .ART One-Word Domains*. Version 2026-04-12. Public GitHub extract for the exact Unique Domains search represented by this repository.
