...
<p align="left">
  ...
  <img alt="public extract" src="https://img.shields.io/badge/public%20extract-8%2C723%20rows-8250df">
...
**Public extract:** 8,723 rows · **Live catalog:** 8,719 domains
...
- `art.csv` — public CSV extract (8,723 rows)
- `art.json` — public JSON extract (8,723 rows)
...
| ----------------------- | ------------------------------------------------ |
| 8,723-row public sample | 8,719 live domains                               |
